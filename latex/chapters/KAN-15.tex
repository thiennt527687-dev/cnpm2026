...
\begin{document}
	...
	{\Huge \textbf{III. Đặc tả yêu cầu phần mềm}}
	
	\vspace{1cm}
	
	{\Large \textbf{1. Tổng quan sản phẩm (Product Overview)}}
	...
	{\Large \textbf{2. Yêu cầu người dùng (User Requirements)}}
	
	\vspace{0.3cm}
	
	{\large \textbf{2.1 Các tác nhân của hệ thống (System Actors)}}
	...
	\begin{longtable}{|c|p{3.8cm}|p{9.5cm}|}
		...
		\endfirsthead % Chỉ hiển thị tiêu đề màu hồng ở trang đầu tiên của bảng
