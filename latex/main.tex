...
% Toàn bộ năm phần của báo cáo được biên dịch từ LaTeX source.
% Không dùng main.tex dạng PDF wrapper và không nhúng các trang báo cáo nền.
% Các ảnh/sơ đồ chỉ được dùng như tài nguyên minh họa trong figures/.
% =========================================================
...
\begin{titlepage}
  ...
  \begin{center}
    ...
    \begin{flushleft}
      ...
      \textbf{Thành viên:}\\
      Lê Mai Thiện Độ -- 054206007557\\
      Nguyễn Đức Phát -- 079206028119\\
      Phùng Thu Ngân -- 077305001805\\
      Nguyễn Trường An -- 086206011067\\
      Nguyễn Thanh Thiện -- 052207007687
    \end{flushleft}
...
\input{chapters/02_project_management_plan}
...
Quên mật khẩu &
Học sinh / Sinh viên &
Cho phép người học yêu cầu đặt lại mật khẩu, xác thực OTP qua email hoặc số điện thoại đã đăng ký và tạo mật khẩu mới. \\
\hline
...
Quản trị viên / Giáo viên; Dịch vụ thông báo (cung cấp trạng thái) &
Theo dõi trạng thái đã gửi, đang xử lý, gửi thành công hoặc thất bại của từng thông báo. \\
\hline

NOT-02 &
Xem báo cáo lỗi gửi &
Quản trị viên / Giáo viên; Dịch vụ thông báo (cung cấp lỗi) &
...
Quản trị viên / Giáo viên (khởi tạo); Dịch vụ thông báo (phân phối) &
Gửi thông báo học tập, cảnh báo và nhắc nhở đến người dùng qua Email, SMS hoặc Push Notification. \\
\hline

NOT-04 &
Lập lịch gửi thông báo &
Quản trị viên / Giáo viên (cấu hình); Dịch vụ thông báo (thực thi) &
...
Học sinh / Phụ huynh (khởi tạo); Cổng thanh toán (xử lý) &
...
% =========================================================
% 3.1.1--3.1.5: Screen Flow và đặc tả được đối chiếu với artifact GitHub của dự án.
% =========================================================
...
\GitHubFlowPng{3.1.1 Academic Administrator Screen Flow}{figures/github/flow_admin_latest.png}{Screen Flow Quản trị viên Học vụ.}
\noindent\textbf{Đặc tả màn hình tương ứng.} Bảng dưới đây mô tả các màn hình và chức năng xuất hiện trong Screen Flow, dùng làm mô tả văn bản đi kèm sơ đồ và làm cơ sở đối chiếu với các yêu cầu chức năng chi tiết ở mục 3.2.

\renewcommand{\arraystretch}{1.12}
\begin{longtable}{|p{3.0cm}|p{4.1cm}|p{7.0cm}|}
\hline
\rowcolor{orange!15}
...
\caption{Đặc tả các màn hình trong Screen Flow Quản trị viên Học vụ}
\end{longtable}
\clearpage

\GitHubFlowPng{3.1.2 Teacher Screen Flow}{figures/github/flow_teacher_latest.png}{Screen Flow Giáo viên / Giảng viên.}
\noindent\textbf{Đặc tả màn hình tương ứng.} Bảng dưới đây mô tả các màn hình và chức năng xuất hiện trong Screen Flow, dùng làm mô tả văn bản đi kèm sơ đồ và làm cơ sở đối chiếu với các yêu cầu chức năng chi tiết ở mục 3.2.
...
\caption{Đặc tả các màn hình trong Screen Flow Giáo viên / Giảng viên}
\end{longtable}
\clearpage

\GitHubFlowPng{3.1.3 Parent Screen Flow}{figures/github/flow_parent_latest.png}{Screen Flow Phụ huynh.}
\noindent\textbf{Đặc tả màn hình tương ứng.} Bảng dưới đây mô tả các màn hình và chức năng xuất hiện trong Screen Flow, dùng làm mô tả văn bản đi kèm sơ đồ và làm cơ sở đối chiếu với các yêu cầu chức năng chi tiết ở mục 3.2.
...
\caption{Đặc tả các màn hình trong Screen Flow Phụ huynh}
\end{longtable}
\clearpage

\GitHubFlowPng{3.1.4 Student Screen Flow}{figures/github/flow_student_latest.png}{Screen Flow Học sinh / Sinh viên.}
\noindent\textbf{Đặc tả màn hình tương ứng.} Bảng dưới đây mô tả các màn hình và chức năng xuất hiện trong Screen Flow, dùng làm mô tả văn bản đi kèm sơ đồ và làm cơ sở đối chiếu với các yêu cầu chức năng chi tiết ở mục 3.2.
...
\caption{Đặc tả các màn hình trong Screen Flow Học sinh / Sinh viên}
\end{longtable}
\clearpage

\GitHubFlowPng{3.1.5 AI Tutor and Personalized Learning Roadmap Screen Flow}{figures/github/flow_ai_personalized_latest.png}{Screen Flow AI Tutor và Cá nhân hóa Lộ trình.}
\noindent\textbf{Đặc tả màn hình tương ứng.} Bảng dưới đây mô tả các màn hình và chức năng xuất hiện trong Screen Flow, dùng làm mô tả văn bản đi kèm sơ đồ và làm cơ sở đối chiếu với các yêu cầu chức năng chi tiết ở mục 3.2.
...
\caption{Đặc tả các màn hình trong Screen Flow AI Tutor và Cá nhân hóa Lộ trình}
\end{longtable}
\clearpage
...
% ERD được trình bày tại Phần IV - Software Design Description / Database Design.
...
\subsubsection{Forgot Password and Reset Password}
\label{subsubsec:forgot-reset-password}

\begin{itemize}
    \item \textbf{Function trigger:}
    \begin{itemize}
        \item Người dùng chọn \textit{Quên mật khẩu?} tại màn hình đăng nhập.
    \end{itemize}
    \item \textbf{Function description:}
    \begin{itemize}
        \item \textbf{Actors/Roles:} Học sinh / Sinh viên và các tài khoản web hợp lệ.
        \item \textbf{Purpose:} Khôi phục quyền truy cập khi người dùng quên mật khẩu mà không tiết lộ tài khoản có tồn tại hay không.
        \item \textbf{Data processing:}
        \begin{enumerate}
            \item Người dùng nhập email/số điện thoại tại route \texttt{/forgot-password}.
            \item Backend tạo OTP đặt lại mật khẩu có thời hạn, giới hạn số lần thử và thời gian gửi lại; phản hồi bên ngoài dùng thông báo chung để hạn chế dò tìm tài khoản.
            \item Người dùng nhập OTP và mật khẩu mới tại route \texttt{/reset-password}.
            \item Hệ thống kiểm tra OTP còn hiệu lực/chưa sử dụng, kiểm tra mật khẩu mới và cập nhật thông tin xác thực.
            \item Sự kiện đặt lại mật khẩu được ghi nhận phục vụ audit/bảo mật.
        \end{enumerate}
        \item \textbf{Business rules:} STU-13; CR-01, CR-02, CR-03, CR-05, CR-06.
        \item \textbf{Screen layout:} Giao diện được triển khai tại \texttt{/forgot-password} và \texttt{/reset-password}; đây là hai bước liên tiếp của cùng luồng khôi phục mật khẩu.
    \end{itemize}
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{enumerate}
            ...
            \item Phản hồi nội dung được lưu theo mô hình dữ liệu \texttt{ContentFeedback}, gồm đối tượng nội dung, người gửi, rating và nội dung phản hồi.
        \end{enumerate}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{enumerate}
            ...
            \item Hệ thống lưu nhận xét/đánh giá tiến độ theo mô hình dữ liệu \texttt{StudentProgressEvaluation}, gắn với học sinh, người đánh giá và nội dung nhận xét.
...
\subsubsection{View Teacher Learning Analytics and Student Progress Reports}
\label{subsubsec:teacher-learning-analytics}

\begin{itemize}
    \item \textbf{Function trigger:}
    \begin{itemize}
        \item Giáo viên chọn khu vực Learning Analytics hoặc báo cáo tiến độ từ Dashboard/lớp đang phụ trách.
    \end{itemize}
    \item \textbf{Function description:}
    \begin{itemize}
        \item \textbf{Actors/Roles:} Giáo viên / Giảng viên.
        \item \textbf{Purpose:} Bao phủ các Use Case TEA-06--TEA-10: theo dõi Learning Analytics, tiến độ học sinh, hiệu quả giảng dạy, Knowledge Tracing và đề xuất nội dung bởi AI.
        \item \textbf{Data processing:}
        \begin{enumerate}
            \item Hệ thống xác định các lớp/học sinh thuộc phạm vi của giáo viên.
            \item Tổng hợp tiến độ lộ trình, kết quả luyện tập/thi, mức độ tham gia và tỷ lệ hoàn thành theo lớp hoặc học sinh.
            \item Kết hợp dữ liệu Knowledge Tracing để hiển thị mức độ thành thạo theo nhóm kiến thức/năng lực.
            \item Tổng hợp mức độ sử dụng tài liệu/câu hỏi và kết quả học tập để hỗ trợ đánh giá hiệu quả nội dung giảng dạy.
            \item Hiển thị các đề xuất AI về nội dung cần bổ sung, độ khó hoặc tài liệu phù hợp; giáo viên giữ quyền quyết định cuối cùng.
        \end{enumerate}
        \item \textbf{Business rules:} TEA-06, TEA-07, TEA-08, TEA-09, TEA-10; CR-03, CR-04, CR-09.
        \ScreenLayoutItem
    \end{itemize}
    \ScreenLayoutFigure{figures/03_02/teacher_class_analysis.png}{Teacher Learning Analytics and Student Progress Reports}
\end{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{enumerate}
            ...
            \item Quyền lợi sau thanh toán được lưu bằng thực thể \texttt{Entitlement}, liên kết với người dùng, gói dịch vụ và giao dịch thanh toán để bảo đảm khả năng truy vết.
...
\subsection{AI Services \& Processing}
\label{subsec:ai-services-processing}

Phân hệ này mô tả các tương tác nội bộ AI-01--AI-10. Đây là các xử lý service không có màn hình độc lập; kết quả được sử dụng bởi AI Tutor, lộ trình cá nhân hóa, luyện tập thích ứng và Learning Analytics.

\begin{itemize}
    \item \textbf{Actors/Roles:} Hệ thống AI / AI Service; các mô-đun Web gọi dịch vụ theo nghiệp vụ tương ứng.
    \item \textbf{Purpose:} Phân tích năng lực, sinh/điều chỉnh lộ trình, gợi ý nội dung, xử lý LLM + RAG, embedding/vector search, dự đoán kết quả và cung cấp dữ liệu phục vụ cải thiện mô hình theo phạm vi cho phép.
    \item \textbf{Data processing:}
    \begin{enumerate}
        \item Nhận dữ liệu học tập/ngữ cảnh từ chức năng gọi dịch vụ và kiểm tra phạm vi dữ liệu.
        \item Với AI Tutor, hệ thống tạo prompt, truy xuất tài liệu liên quan bằng RAG/Vector Search và gọi provider LLM đã cấu hình.
        \item Với Knowledge Tracing/Prediction, hệ thống tổng hợp bằng chứng học tập để ước lượng mức thành thạo và dự đoán kết quả.
        \item Với Roadmap/Adaptive Practice, hệ thống sử dụng mục tiêu, năng lực, lịch sử kết quả và tiến độ để đề xuất nội dung/thứ tự/độ khó phù hợp.
        \item Kết quả AI được lưu hoặc trả về mô-đun nghiệp vụ tương ứng; lỗi provider phải được xử lý theo CR-10 và không tự chuyển thành trạng thái thành công.
    \end{enumerate}
    \item \textbf{Business rules:} AI-01--AI-10; CR-03, CR-04, CR-05, CR-06, CR-10.
    \item \textbf{Screen layout:} Không có màn hình riêng; kết quả được hiển thị trong AI Tutor, Personalized Roadmap, Adaptive Practice và Analytics.
\end{itemize}

\subsection{Education Organization Synchronization}
\label{subsec:education-organization-sync}

Phân hệ này đặc tả các Use Case EDU-01--EDU-06 dùng để đồng bộ dữ liệu tham chiếu từ Tổ chức giáo dục/Đơn vị ra đề ĐGNL. Đây là luồng tích hợp hệ thống, không phải một Screen Flow người dùng cuối.

\begin{itemize}
    \item \textbf{Actors/Roles:} Tổ chức giáo dục / Đơn vị ra đề ĐGNL; hệ thống AI-Edu Pathways.
    \item \textbf{Purpose:} Đồng bộ đề thi mẫu, cấu trúc/ma trận đề, chuẩn đầu ra/khung năng lực, thống kê kết quả, độ khó câu hỏi và phân bố điểm/năng lực.
    \item \textbf{Data processing:}
    \begin{enumerate}
        \item Hệ thống xác thực nguồn tích hợp và tiếp nhận gói dữ liệu theo định dạng/API đã cấu hình.
        \item Kiểm tra định danh, phiên bản và tính hợp lệ trước khi tạo mới hoặc cập nhật dữ liệu tham chiếu.
        \item Đồng bộ quan hệ giữa kỳ thi, đề thi, câu hỏi, ma trận kiến thức/khung năng lực và các metadata thống kê liên quan.
        \item Ghi nhận trạng thái đồng bộ, lỗi và thời điểm cập nhật để hỗ trợ kiểm tra/audit.
        \item Dữ liệu đã đồng bộ chỉ được công bố/sử dụng khi đáp ứng trạng thái và quy tắc nghiệp vụ tương ứng.
    \end{enumerate}
    \item \textbf{Business rules:} EDU-01--EDU-06; CR-02, CR-05, CR-07, CR-10, CR-12.
    \item \textbf{Screen layout:} Không có màn hình bắt buộc cho tác nhân ngoài; quản trị viên có thể theo dõi trạng thái qua các chức năng quản trị/báo cáo nếu được triển khai.
\end{itemize}
...
% System Architecture / Package / Database Design là LaTeX source;
% Detailed Design dùng 10 Class Diagram và 10 Sequence Diagram mới.
% =========================================================
\clearpage
\setcounter{figure}{34}
\input{chapters/04_software_design_intro}
\input{chapters/04_detailed_design_from_drawio}
\setcounter{figure}{96}

% =========================================================
% V. SOFTWARE TESTING DOCUMENTATION
% =========================================================
\clearpage
\input{chapters/05_software_testing_documentation}
